...
type TftSummonerApiKeyCreationAttributes = Optional<
  TftSummonerApiKeyAttributes,
  "tftSummonerApiKeyId"
>;
export class TftSummonerApiKey
  extends Model<
    TftSummonerApiKeyAttributes,
    TftSummonerApiKeyCreationAttributes
  >
  implements TftSummonerApiKeyAttributes {
  tftSummonerApiKeyId!: number;
  tftSummonerId!: number;
  tftApiKeyId!: number;
  encryptedPlayerUuid!: string;
        ...
        indexes: [
          {
            ...
            unique: true,
            fields: [{ name: "tft_summoner_api_key_id" }],
          },
          {
            name: "tft_summoner_api_key_unq",
            unique: true,
            fields: [{ name: "tft_summoner_id" }, { name: "tft_api_key_id" }],
          },
        ],
      }
    );
