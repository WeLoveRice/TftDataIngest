...
import { TftSummoner } from "./init-models";
...
export class TftSummonerElo
  extends Model<TftSummonerEloAttributes, TftSummonerEloAttributes>
  implements TftSummonerEloAttributes {
  tftSummonerEloId?: number;
  tftSummonerId?: number;
  tftEloId?: number;
  summonerEloTimestamp?: Date;
  ...
  public static associations: {
    tftSummoner: Association<TftSummonerElo, TftSummoner>;
  };
        ...
        indexes: [
          {
            ...
            unique: true,
            fields: [{ name: "tft_summoner_elo_id" }],
          },
          {
